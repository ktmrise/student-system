...
<ul class="list-group" style="margin-top: 30px">
    <li class="list-group-item text-center"><a href="${pageContext.request.contextPath}/back/clazz/index.jsp" target="content">班级管理</a></li>
    ...
    <li class="list-group-item text-center"><a href="${pageContext.request.contextPath}/tag/findAll" target="content">标签管理</a></li>
